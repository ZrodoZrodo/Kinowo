  ...
  return (
    <div className="bg-dark-purple h-full w-full">
      ...
      <div className="flex flex-wrap m-8">
        <div className="">
          <p className="text-white sm:text-6xl text-2xl underline underline-offset-2 decoration-purple decoration-2"> Historia. </p>
          ...
          <p className="text-white sm:text-center md:text-left  sm:w-1/3 w-full mt-6">
            ...
            Przez przeglądanie tej sekcji możesz przypomnieć sobie filmy, które
            już oglądałeś i odkryć nowe tytuły, które warto jeszcze raz
            obejrzeć.
          </p>
