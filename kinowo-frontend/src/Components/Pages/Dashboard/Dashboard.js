        ...
        <>
          <div className="bg-dark-purple h-full w-full">
            ...
            <div className="grid justify-items-center w-full mb-4">
              <div
                  className="border-2 border-l-transparent border-r-transparent border-t-purple border-b-transparent rounded-null w-1/2  "></div>
              <div className="Dashboard_banner w-4/6 sm:h-80  mt-6 grid ">
                <p className=" text-xl m-6 text-dashboard-pink">
                  {cookie.UserData.name.charAt(0).toUpperCase() + cookie.UserData.name.slice(1)} witaj w naszym
                  serwisie!
                </p>
              ...
              <div className="grid md:grid-cols-3  grid-cols-1  gap-4 place-items-center w-full mt-24 ">
                <div className="Burger text-3xl text-center w-max-md cursor-pointer"
              ...
              <div
                  className="border-2 border-l-purple border-r-transparent border-t-transparent border-b-transparent rounded-null h-40 mt-24"></div>
            </div>
          </div>
          <Footer></Footer>
        </>
